...
export const timelineData: Timelines = {
  ...
  intro01:[
    ...
    {type: 'timelineTransition', timelineID: 'intro02'},
  ],
  intro02:[
...
//--------------------------------------------------------------
  ...
  {type: 'fadeIn'},
  {type: 'dialog', text: 'この他にも、ラノベの主人公になりきってた話、\n女の子が自分のこと絶対好きだと勘違いしてた話、\n高校の授業中に課金し3万ドブに捨てた話\n好きな子にガチでキレられる話など・・・'},
  {type: 'dialog', text: '通してプレイしていただくと。\n「こんな人生送ってきて岩田ができたんだな」\nと感じていただけるものになっていると思います。'},
  {type: 'dialog', text: 'ぜひプレイしていただきたいです。'},
  {type: 'timelineTransition', timelineID: 'pre08'}
  ],
  pre08:[//エピソード紹介
  {type: 'setBackground', x: 400, y: 300, key: 'pre08'},
  {type: 'dialog', text: '今回紹介できませんでしたが、実は、ゲーム内に宇津木くんが出演してくれています。'},
  {type: 'dialog', text: '宇津木くんを探してみてください。'},
  {type: 'dialog', text: 'ありがとうございました。'},
  {type: 'sceneTransition', key: 'ending'}
  ],
